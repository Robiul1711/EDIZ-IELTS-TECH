    ...
    <div className="flex flex-col items-center gap-8 py-6 w-full mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100 dark:border-slate-800 p-8 md:p-10 w-full max-w-3xl text-center ring-1 ring-black/5 dark:ring-slate-800">
        ...
        <p className="text-gray-500 dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto text-sm md:text-base">
          You will hear a recording about empathy. At the end of the recording
          the last word or group of words has been replaced by a beep. Select
          the correct option to complete the recording.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-start">
        ...
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-slate-800 p-8 md:p-10 h-full ring-1 ring-black/5 dark:ring-slate-800 flex flex-col">
          <h2 className="text-gray-800 dark:text-white font-bold text-lg md:text-xl mb-10 leading-snug">
            What is the main idea that the speaker is trying to convey in the
            lecture?
          </h2>
              ...
              return (
                <button
                  ...
                  className={`w-full group text-left flex items-center gap-4 p-4 rounded-xl border transition-all duration-300 ${
                    isSelected
                      ? "bg-[#8673FF]/10 dark:bg-[#8673FF]/20 border-[#8673FF] shadow-sm"
                ...
                >
                  ...
                  <div
                    className={`flex-shrink-0 w-6 h-6 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${
                      isSelected
                        ? "border-[#8673FF]"
                        : "border-gray-200 dark:border-slate-600 group-hover:border-[#8673FF]/50"
                    }`}
                  >
                    <div
