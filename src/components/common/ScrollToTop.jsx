  ...
  return (
    <div className="fixed bottom-4 left-4  z-[100]">
      {isVisible && (
        <button
          onClick={scrollToTop}
          className="group relative flex items-center justify-center w-10 h-10  bg-gradient-to-br from-indigo-600 to-purple-700 text-white rounded-full shadow-lg shadow-indigo-500/30 dark:shadow-indigo-900/50 hover:shadow-xl hover:shadow-indigo-500/40 dark:hover:shadow-indigo-900/60 transition-all duration-500 animate-in fade-in zoom-in slide-in-from-bottom-5 hover:scale-110 active:scale-95 ring-4 ring-white/10 dark:ring-slate-800/50"
