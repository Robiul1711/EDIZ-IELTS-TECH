    ...
    return (
        <div className="w-full flex flex-col items-center font-poppins">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-lg p-4 md:p-10 w-full mb-10 border border-gray-50 dark:border-slate-800 flex flex-col gap-6 max-w-4xl">
                <h2 className="text-2xl font-bold text-black dark:text-white">Summarize group discussion</h2>

                <div className="bg-[#FFFCE5] dark:bg-slate-800 border border-yellow-200 dark:border-slate-800 rounded-xl p-4">
                    <p className="text-base font-semibold text-black dark:text-white">
                        You have 10 seconds to prepare and 2 Minutes to record.
                    </p>
                </div>

                <div className="text-gray-700 dark:text-white text-base leading-relaxed space-y-2">
                    <p>
                        You Will hear three people having a discussion. When you hear the beep, Summarize the Whole discussion. You Will have IO seconds to prepare and 2 minutes to give your response.
                    </p>
                </div>
                <img src={ImageAssets.group} alt="" />
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full  mb-12 max-w-7xl">
                ...
                <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-xl p-4 border border-gray-50 dark:border-slate-800 flex flex-col items-center gap-6">
                    <div className="w-full py-16 flex flex-col items-center justify-center gap-6 border border-gray-100 dark:border-slate-800 rounded-[2rem]">
                        ...
                        <div className="text-center space-y-1">
                            ...
                            <p className="text-gray-500 font-medium text-base dark:text-white">
                    ...
                    <div className="w-full flex items-center gap-4 pt-4">
                        <div className="p-2 rounded-full bg-gray-50 dark:bg-slate-800 text-gray-400 dark:text-white">
                            <MicOff size={20} />
                        </div>
                        <div className="flex-1 flex flex-col gap-1">
                            <div className="flex justify-between text-sm font-bold text-gray-500 dark:text-white">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-xl p-4 border border-gray-50 flex flex-col items-center gap-6">
                    <div className="w-full  py-16 flex flex-col items-center justify-center gap-6 border dark:border-slate-800 border-gray-100 rounded-[2rem]">
                        {status === 'recording' ? (
            ...
            <footer className="z-10 w-full pb-10 px-4 md:px-10">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <Link to="/pte-examination/respond-situation" className="w-full md:w-auto">
...
export default PTEGroupDiscussion;
