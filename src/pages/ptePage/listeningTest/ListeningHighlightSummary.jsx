  ...
  return (
    <div className="flex flex-col items-center gap-8 py-6 w-full mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-start">
        ...
        {/* Summaries Container */}
        <div className="bg-white dark:bg-slate-900 rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 dark:border-slate-800 p-4 md:p-6 ring-1 ring-black/5 dark:ring-slate-800">
