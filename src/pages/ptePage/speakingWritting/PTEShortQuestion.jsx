...
const PTEShortQuestion = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center font-poppins transition-colors duration-300">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-3xl shadow-lg p-6 md:p-10 w-full mb-4 md:mb-10 border border-gray-100 dark:border-slate-800 flex flex-col gap-6 max-w-4xl animate-in fade-in slide-in-from-top duration-500">
        ...
        <div className="text-slate-600 dark:text-slate-400 text-sm md:text-base leading-relaxed space-y-4">
          <p>
          ...
          <div className="bg-slate-50 dark:bg-slate-800 p-2 md:p-4 rounded-2xl border border-gray-100 dark:border-slate-700">
            <img
              src={ImageAssets.group}
      ...
      {/* Dual Status Cards */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 w-full mb-4 md:mb-12 max-w-7xl">
      ...
      <footer className="w-full py-4 mt-auto">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link
            to="/pte-examination/respond-situation"
...
export default PTEShortQuestion;
