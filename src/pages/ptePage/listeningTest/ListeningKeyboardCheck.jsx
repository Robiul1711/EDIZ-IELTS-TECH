...
const ListeningKeyboardCheck = () => {
    return (
        ...
        <div className='flex flex-col min-h-screen items-center gap-6 md:gap-10 px-4 pb-10'>
            ...
            <ul className="list-decimal space-y-3 mt-4 text-base md:text-lg  max-w-2xl">
            ...
            <div className="flex flex-col-reverse md:flex-row gap-4 w-full md:w-auto mt-auto md:mt-0">
                ...
                <Link to="/pte/listening/syllubus">
            ...
            <p className="">In the actual test, you will use a QWERTY keyboard.</p>
        </div>
    );
};

export default ListeningKeyboardCheck;