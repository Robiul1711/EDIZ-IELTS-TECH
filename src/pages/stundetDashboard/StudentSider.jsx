...
const StudentSider = ({ isOpen, onClose }) => {
  const menuItems = [
    ...
    { name: "CLASSROOM", icon: ClassRoomImage, path: "/student-dashboard/classroom" },
            ...
            >
              {({ isActive }) => (
                <>
                  ...
                  <span className={`text-[15px] font-bold tracking-wider uppercase ${isActive ? "text-[#333]" : "text-white"}`}>
                    {item.name}
                  </span>
                </>
              )}
