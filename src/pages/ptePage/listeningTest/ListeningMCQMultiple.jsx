...
const ListeningMCQMultiple = () => {
    ...
    const options = [
        { id: 'A', text: "the hero's journey is the most common type of story structure in literature." },
        { id: 'B', text: "heroes return from their journey in a much different condition than when they left." },
        { id: 'C', text: "Heroes face challenges that demand both strength and cleverness." },
        { id: 'D', text: "Joseph Campbell developed the hero's-journey structure after his travels." },
        { id: 'E', text: "These stories attract big audiences because their themes feel universal." },
    ];
        ...
        <div className="flex flex-col items-center gap-8 py-6 w-full max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
            ...
            <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100 p-8 md:p-10 w-full max-w-3xl text-center ring-1 ring-black/5">
                ...
                <p className="text-gray-500 font-medium leading-relaxed max-w-2xl mx-auto text-sm md:text-base">
                    Listen to the recording answer the question by selecting all the correct responses.
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
                ...
                <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-10 h-full ring-1 ring-black/5">
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className={`font-bold text-lg ${isSelected ? 'text-[#8673FF]' : 'text-gray-800'}`}>
                                            {option.id}
                                        </span>
