    ...
    return (
        <div className="flex flex-col items-center gap-8 py-6 w-full mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full">
                ...
                {/* Question Card */}
                <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12 h-full ring-1 ring-black/5 flex flex-col">
                    <div className="text-gray-700 leading-[2.8] text-base md:text-lg font-medium">
                        <p className="inline">Historians have long debated the true identity of the legendary King Arthur, a figure shrouded in myth and </p>
                        <input
                            type="text"
                            value={blanks.blank1}
                            onChange={(e) => handleInputChange(e, 'blank1')}
                            className="inline-block w-32 h-9 px-3 mx-1 align-middle border-2 border-slate-200 rounded-lg focus:border-[#8673FF] outline-none transition-all "
                        />
                        <p className="inline">. Some think he might have been a leader fighting against </p>
                        <input
                            type="text"
                            value={blanks.blank2}
                            ...
                            className="inline-block w-32 h-9 px-3 mx-1 align-middle border-2 border-slate-200 rounded-lg focus:border-[#8673FF] outline-none transition-all"
                        />
                        <p className="inline"> in the 5th and 6th centuries, while others believe he's purely a myth. The debate is </p>
                        <input
                            type="text"
                            value={blanks.blank3}
                            ...
                            className="inline-block w-32 h-9 px-3 mx-1 align-middle border-2 border-slate-200 rounded-lg focus:border-[#8673FF] outline-none transition-all"
                        />
                        <p className="inline"> by the lack of contemporary historical records and the abundance of legendary tales knights of the Round Table. Even though we don't have solid proof, people still love the story of King Arthur, and it has inspired </p>
                        <input
                            type="text"
                            value={blanks.blank4}
