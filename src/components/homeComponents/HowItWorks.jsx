    ...
    >
      <div className="">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
          ...
          <div
            ref={imageRef}
            className="lg:col-span-7  rounded-2xl min-h-[400px]  shadow-xl "
          >
            <img src={ImageAssets.howitwork} alt="" />
          </div>

          {/* RIGHT SIDE: Content Card */}
          <div
            ref={contentRef}
            className="lg:col-span-5 bg-gradient-to-b from-[#604CDF] to-[#884BBE] rounded-[32px] p-10 md:p-14 flex flex-col justify-center items-start shadow-xl text-left relative overflow-hidden"
          >
            {" "}
