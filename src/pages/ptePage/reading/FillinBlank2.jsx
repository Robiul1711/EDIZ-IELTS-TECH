...
const FillinBlank2 = () => {
    const initialWords = ['Razed', 'Defined', 'Throughout', 'Alongside', 'Replaced', 'Depended'];
    ...
    const Blank = ({ id, value }) => (
        <div
            ...
            className={`inline-block align-middle mx-1 min-w-[120px] h-9 border-2 border-dashed rounded-lg transition-all duration-200 ${value
    ...
    return (
        <div className="flex flex-col items-center gap-8 py-6 w-full max-w-6xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
            ...
            {/* Main Question Card */}
            <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-gray-100 w-full overflow-hidden flex flex-col">
                {/* Header Decoration */}
                ...
                <div className="p-8 md:p-12 space-y-10">
                    ...
                    <div className="p-5 bg-gray-50/80 rounded-2xl border border-gray-100">
                        <p className="text-gray-700 font-medium text-sm md:text-base leading-relaxed">
                            In text some words are missing. Drag words from the box below to the appropriate place in the text. To undo an answer choice, drag the word back to the box below the text.
                        </p>
                    </div>

                    {/* Passage Container */}
                    <div className="text-gray-700 leading-[2.5] text-base">
                        <p className="inline">Gothic architecture is a style of architecture that spread </p>
                        <Blank id="blank1" value={blanks.blank1} />
                        <p className="inline"> Europe from the late 12th century to the 16th century. This architectural style emphasised verticality and large, often stained glass windows. The design elements that </p>
                        <Blank id="blank2" value={blanks.blank2} />
                        <p className="inline"> and supported this style of construction were pointed arches and flying buttresses. Earlier Romanesque architecture </p>
                        <Blank id="blank3" value={blanks.blank3} />
                        <p className="inline"> on thick stone walls to withstand downward pressure, but the arches and flying buttresses of Gothic architecture replaced these walls and displaced the weight outward.</p>
                    </div>
                </div>
                ...
                <div
                    onDragOver={allowDrop}
                    onDrop={onDropToBank}
                    className="bg-slate-100/80 p-8 border-t border-gray-100 min-h-[140px]"
                >
                    <div className="flex flex-wrap justify-center gap-4">
                        {availableWords.map((word, index) => (
                            <div
                                ...
                                className="group flex items-center gap-2 bg-white px-5 py-2.5 rounded-xl border border-gray-200 shadow-sm cursor-grab active:cursor-grabbing hover:border-[#8673FF] hover:shadow-md transition-all duration-200"
                            >
                                <Move size={14} className="text-gray-400 group-hover:text-[#8673FF]" />
                                <span className="text-sm font-semibold text-gray-700 group-hover:text-[#8673FF]">
                                    {word}
                                </span>
                            </div>
                        ))}
