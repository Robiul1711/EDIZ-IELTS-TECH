    ...
    return (
        <div className="w-full flex flex-col items-center font-poppins">
            ...
            <div className="bg-white rounded-3xl shadow-lg p-8 md:p-10 w-full mb-10 border border-gray-50 flex flex-col gap-6 max-w-4xl">
                <h2 className="text-2xl font-bold text-black">Repeat sentence</h2>

                <div className="bg-[#FFFCE5] border border-yellow-200 rounded-xl p-4">
                    <p className="text-base font-semibold text-black">
                        You have <span className="font-bold">15 seconds to prepare</span> and <span className="font-bold">10 seconds to record.</span>
                    </p>
                </div>

                <div className="text-gray-700 text-base leading-relaxed space-y-2">
                    <p>You hear one sentence. Please repeat the sentence exactly as you hear it. You hear the sentence only once.</p>
                </div>
            </div>
            ...
            <footer className="z-10 w-full pb-10 px-4 md:px-10">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <Link to="/pte-examination/describe-image" className="w-full md:w-auto">
