        ...
        <div className="flex flex-col items-center gap-8 py-6 w-full mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins">
            ...
            <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-gray-100 p-8 md:p-10 w-full max-w-3xl text-center ring-1 ring-black/5">
                ...
                <p className="text-gray-500 font-medium leading-relaxed max-w-2xl mx-auto text-sm md:text-base">
                    You will hear a recording. Below is a transcription of the recording. Some words in the transcription differ from what the speakers said. Please click on the words that are different.
                </p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full items-start">
                ...
                {/* Transcription Card */}
                <div className="bg-white rounded-[2rem] shadow-[0_20px_50px_rgba(0,0,0,0.05)] border border-gray-100 p-8 md:p-12 h-full ring-1 ring-black/5">
                    <div className="text-gray-700 leading-[2] text-base md:text-sm font-medium flex flex-wrap gap-x-1.5">
                        {words.map((word, index) => {
                            ...
                            return (
                                <span
                                    ...
                                    className={`cursor-pointer transition-all duration-200 px-1 rounded-md active:scale-95 ${isHighlighted
