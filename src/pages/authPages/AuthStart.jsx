    ...
    <div className="w-full max-w-sm bg-white dark:bg-slate-900 rounded-[32px] overflow-hidden shadow-2xl border border-transparent dark:border-slate-800">
     ...
     <Link to="/">
      ...
      <div className="p-8 pt-6">
        <h2 className="text-[#5D5FEF] dark:text-indigo-400 text-lg font-bold mb-6">
          Login/Sign Up
        </h2>
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <span className="text-white font-semibold text-sm pl-6">
              Start with Google
            </span>
          </button>

          {/* Email Button (Changed from button to Link for proper navigation) */}
          <Link
            to="/auth/login"
            className="group relative w-full flex items-center justify-center bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 py-3 rounded-full hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors active:bg-gray-100 dark:active:bg-slate-600"
          >
            <div className="absolute left-2 bg-[#E2E4E9] dark:bg-slate-700 rounded-full p-2">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <span className="text-gray-600 dark:text-slate-300 font-semibold text-sm pl-6">
              Start with Email
            </span>
          </Link>
        </div>
