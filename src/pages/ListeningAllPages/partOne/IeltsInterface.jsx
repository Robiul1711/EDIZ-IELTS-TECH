...
const IeltsInterface = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-slate-950 section-padding-x py-8 text-slate-600 dark:text-slate-400 font-sans">
      {/* --- Top Header --- */}
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-gray-100 dark:border-slate-800 p-6 mb-6">
      ...
      {/* --- Instruction Box --- */}
      <div className="bg-indigo-50/50 dark:bg-indigo-900/10 rounded-xl border border-indigo-100 dark:border-indigo-900/30 p-8 mb-8 shadow-sm">
        <div className="mb-4">
      ...
      {/* --- The Table --- */}
      <div className="bg-white dark:bg-slate-900 rounded-3xl border border-[rgba(49,65,88,0.12)] dark:border-slate-800 shadow-[0_2px_12px_0_rgba(0,0,0,0.12)] overflow-hidden mb-10">
          ...
          <table className="w-full text-sm text-center border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-200 font-bold border-b border-gray-200 dark:border-slate-800">
                <th className="p-5 border-r border-gray-200 dark:border-slate-800 w-1/6">
                  Spa Package
                </th>
                <th className="p-5 border-r border-gray-200 dark:border-slate-800 w-1/6">
                  Service 1
            ...
            <tbody className="text-slate-600 dark:text-slate-400">
              ...
              <tr className="border-b border-gray-200 dark:border-slate-800 hover:bg-gray-50 dark:hover:bg-slate-800/50 transition-colors">
                <td className="p-4 border-r border-gray-200 dark:border-slate-800">
                ...
                <td className="p-4 border-r border-gray-200 dark:border-slate-800 text-gray-400 dark:text-slate-600 italic">
                  N/A
                </td>
      ...
      <div className="bg-indigo-50/30 dark:bg-indigo-900/10 p-8 rounded-xl border border-indigo-50 dark:border-indigo-900/30">
        ...
        <div className="space-y-4 max-w-4xl">
          ...
          <div className="flex items-center gap-3">
            <span className="text-slate-800 dark:text-slate-200 font-semibold min-w-[100px]">
              Package type:
            </span>
            ...
            <input
              type="text"
              className="flex-1 max-w-xs h-9 border border-gray-200 dark:border-slate-700 rounded bg-white dark:bg-slate-800 px-3 focus:outline-none focus:border-indigo-400 text-slate-900 dark:text-white"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-indigo-700 dark:text-indigo-400 font-bold text-sm ml-2">
              10.
            </span>
            <input
              type="text"
          ...
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <input
              type="text"
              className="w-32 h-9 border border-gray-200 dark:border-slate-700 rounded bg-white dark:bg-slate-800 px-3 focus:outline-none focus:border-indigo-400 text-slate-900 dark:text-white"
            />

            <span className="text-slate-800 dark:text-slate-300 font-medium ml-2">
              at
            </span>
            <span className="text-indigo-700 dark:text-indigo-400 font-bold text-sm">
              10.
