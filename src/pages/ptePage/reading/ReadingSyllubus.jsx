        ...
        <div className="border border-gray-300 dark:border-slate-700 rounded-2xl overflow-hidden">
          <table className="w-full text-left border-collapse">
            ...
            <tbody>
              ...
              <tr className="border-b border-gray-300 dark:border-slate-700">
                <td
                  className="py-4 px-6 font-bold text-gray-700 dark:text-slate-300 border-r border-gray-300 dark:border-slate-700 align-top"
                  rowSpan={8}
                >
                  Section-01
                </td>
              ...
              <tr>
                <td className="py-4 px-6 border-b border-gray-200 dark:border-slate-800 border-r border-gray-300 dark:border-slate-700 hover:bg-gray-50 dark:hover:bg-slate-800 dark:text-slate-400 transition-colors">
