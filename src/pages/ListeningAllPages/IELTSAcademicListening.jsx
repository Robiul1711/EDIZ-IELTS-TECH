...
const IELTSAcademicListening = () => {
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-4">
      ...
      <div className="flex gap-8 w-full max-w-5xl mb-16">
        ...
        <div className="flex-1 bg-white border border-gray-200 rounded-3xl p-10">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center">
              <span className="h-2 w-2 bg-purple-600 rounded-full mr-3"></span>
              <span className="text-gray-700">You can change answers any time</span>
            </li>
          </ul>
        </div>
        ...
        <div className="flex-1 bg-white border border-gray-200 rounded-3xl p-10">
          ...
          <ul className="space-y-4">
            ...
            <li className="flex items-center">
              <span className="h-2 w-2 bg-purple-600 rounded-full mr-3"></span>
              <span className="text-gray-700">Audio plays once</span>
            </li>
            <li className="flex items-center">
              <span className="h-2 w-2 bg-purple-600 rounded-full mr-3"></span>
      ...
      {/* Start Test Button */}
      <Link to="/listening/part1" className="bg-gray-900 text-white font-bold py-5 px-16 gap-2 rounded-xl flex items-center text-xl transition-colors hover:bg-gray-800">
        Start Test
        <FaAnglesRight />
      </Link>
    </div>
