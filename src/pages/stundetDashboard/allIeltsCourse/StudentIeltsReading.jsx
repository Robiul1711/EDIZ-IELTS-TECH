                      ...
                      <div className="flex items-center gap-2 relative z-10">
                        {test?.is_submit ? (
                          ...
                          <>
                            {user && (
                              <Link
                                to={`/keyboard-check?returnTo=${encodeURIComponent(`/reading-test/${test.test_no}/part/1?book=${book.book_no}&type=${type}`)}`}
                          ...
                          <div className="w-full flex items-start justify-between">
                            ...
                            <div className="flex items-center gap-2">
                              {test?.is_submit ? (
                                ...
                                <Link
                                  to={`/keyboard-check?returnTo=${encodeURIComponent(`/reading-test/${test.test_no}/part/${part.part_no}?book=${book.book_no}&type=${type}`)}`}
