        ...
        <div className="w-full flex flex-col items-center">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 w-full mb-12">
                ...
                <div className="bg-white rounded-3xl shadow-xl p-8 md:p-10 flex flex-col gap-6 border border-gray-50">
                    <h2 className="text-2xl font-bold text-black">Personal Introductions</h2>

                    <div className="bg-[#FFFCE5] border border-yellow-200 rounded-xl p-4">
                        <p className="text-base font-semibold text-black">
                            You have <span className="font-bold">25 seconds to prepare</span> and <span className="font-bold">30 seconds to record.</span>
                        </p>
                    </div>

                    <p className="text-gray-700 text-base leading-relaxed ">
                        Read the prompt below and record your response. This is a chance to introduce yourself to institutions you are applying to.
                    </p>

                    <div className="space-y-4">
                        <h3 className="text-lg font-bold text-black">You Should Include:</h3>
                        <ul className="space-y-4 ml-2">
                            {[
                                ...
                                <li key={idx} className="flex items-start gap-3 text-base text-gray-700">
                                    <div className="w-2.5 h-2.5 bg-[#8673FF] rounded-full mt-2 flex-shrink-0 shadow-[0_0_8px_#8673FF]"></div>
                                    {item}
                                </li>
                            ))}
                        </ul>
                    ...
                    <p className="text-gray-600 text-base font-medium mt-4">
                        Speak clearly and naturally. Your response will be sent to the institutions you select.
                    </p>
                </div>
            ...
            <footer className="z-10 w-full pb-10 px-4 md:px-10">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <Link to={"/pte-examination/read-aloud"}>
                        <button className="bg-gradient-to-r from-[#A22BDE] to-[#8673FF] text-white px-16 py-5 rounded-2xl font-bold flex items-center justify-center gap-3 text-lg shadow-2xl hover:opacity-95 transition-all active:scale-[0.98] w-full md:w-auto">
