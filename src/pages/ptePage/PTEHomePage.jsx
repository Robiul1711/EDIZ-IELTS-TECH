  ...
  return (
    <div className="section-padding-x py-12  w-full">
      ...
      <Link to="/ielts/full-test" className="group block w-full">
        <div className="p-10 rounded lg:rounded-2xl bg-white dark:bg-slate-900 hover:bg-gray-200 dark:hover:bg-slate-800 transition-all duration-300 flex items-center justify-between gap-6 relative overflow-hidden shadow-sm hover:shadow-md border border-transparent dark:border-slate-800">
          <div className="z-10">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        {PTECategory.map((category) => (
          ...
          >
            <div
              className="p-10 h-full rounded lg:rounded-2xl flex items-center justify-between gap-4 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg dark:hover:shadow-purple-900/20"
