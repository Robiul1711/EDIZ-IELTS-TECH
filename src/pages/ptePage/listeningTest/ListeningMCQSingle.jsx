  ...
  return (
    <div className="flex flex-col items-center gap-6 md:gap-10  md:py-8  w-full max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700 font-poppins text-slate-800 dark:text-white">
      ...
      <div className="w-full text-left">
        <h1 className="text-xl md:text-3xl font-bold text-slate-800 dark:text-white mb-2 md:mb-6 tracking-tight">
            ...
            {options.map((option) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`flex-shrink-0 w-6 h-6 mt-0.5 rounded-full flex items-center justify-center border-2 transition-all duration-300 ${
                      isSelected
      ...
      <div className="flex flex-col-reverse md:flex-row gap-4 md:gap-6 w-full md:w-auto  md:mt-10 self-center">
        ...
        <Link
          to="/pte-examination-listening/highlight-correct-summary"
